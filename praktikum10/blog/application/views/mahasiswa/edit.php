...
<?php echo form_open("mahasiswa/save") ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tmp_lahir" name="tmp_lahir" placeholder="Masukkan Tempat Lahir" type="text" value="<?php echo $obj_mahasiswa->tmp_lahir?>" class="form-control" spellcheck="false" data-ms-editor="true">
    </div>
  </div>
  <div class="form-group row">
